    ...
    <div className="min-h-screen bg-gradient-to-br from-dark via-gray-dark to-darker">
      ...
      <section className="relative overflow-hidden pt-20 pb-12">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-400 mb-6">
            ...
            <span className="text-gray-300">О проекте</span>
          </div>
      ...
      <section className="py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 rounded-2xl border border-gray-700 p-8 text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-primary/20 rounded-2xl mb-4">
              <Target className="w-8 h-8 text-primary" />
            </div>
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Наша миссия</h2>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {stats.map((stat, index) => (
              <div key={index} className="bg-gray-800/30 rounded-xl p-6 text-center border border-gray-700 hover:border-primary/30 transition-all group">
      ...
      <section className="py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">Что мы предлагаем</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <div key={index} className="bg-gray-800/30 rounded-xl p-6 border border-gray-700 hover:border-primary/30 transition-all group">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl p-6 border border-primary/20">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-semibold text-white">Почему GuitarSync?</h3>
              </div>
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-300">✅ <strong>Полностью бесплатно</strong> — никаких скрытых платежей</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-300">🎸 <strong>Реальное обучение</strong> — играйте на своей гитаре через микрофон</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-300">📊 <strong>Отслеживание прогресса</strong> — видите свои успехи</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-300">🎮 <strong>Игровой формат</strong> — учитесь с удовольствием</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-300">🆓 <strong>Без рекламы</strong> — ничто не отвлекает от занятий</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-800/30 rounded-2xl border border-gray-700 p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-semibold text-white">Для кого этот сайт?</h3>
              </div>
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  <div className="w-6 h-6 bg-blue-500/20 rounded-full flex items-center justify-center text-blue-400 text-xs">1</div>
                  <span className="text-gray-300"><strong>Начинающих гитаристов</strong> — которые только берут гитару в руки</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-6 h-6 bg-green-500/20 rounded-full flex items-center justify-center text-green-400 text-xs">2</div>
                  <span className="text-gray-300"><strong>Любителей</strong> — кто хочет расширить свой репертуар</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-6 h-6 bg-purple-500/20 rounded-full flex items-center justify-center text-purple-400 text-xs">3</div>
                  <span className="text-gray-300"><strong>Опытных музыкантов</strong> — для разминки и изучения новых песен</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-6 h-6 bg-orange-500/20 rounded-full flex items-center justify-center text-orange-400 text-xs">4</div>
                  <span className="text-gray-300"><strong>Преподавателей</strong> — как дополнительный инструмент для учеников</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">Наша команда</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {teamMembers.map((member, index) => (
              <div key={index} className="bg-gray-800/30 rounded-xl p-6 text-center border border-gray-700 hover:border-primary/30 transition-all w-64">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 rounded-2xl border border-gray-700 p-8">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-xl font-bold text-white">Планы развития</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-center gap-3 p-3 bg-gray-800/50 rounded-lg">
                <div className="w-8 h-8 bg-primary/20 rounded-lg flex items-center justify-center">🎸</div>
                <span className="text-gray-300">Ещё больше песен и аккордов</span>
              </div>
              <div className="flex items-center gap-3 p-3 bg-gray-800/50 rounded-lg">
                <div className="w-8 h-8 bg-primary/20 rounded-lg flex items-center justify-center">📱</div>
                <span className="text-gray-300">Мобильное приложение</span>
              </div>
              <div className="flex items-center gap-3 p-3 bg-gray-800/50 rounded-lg">
                <div className="w-8 h-8 bg-primary/20 rounded-lg flex items-center justify-center">🎓</div>
                <span className="text-gray-300">Видео-уроки и теоретические материалы</span>
              </div>
              <div className="flex items-center gap-3 p-3 bg-gray-800/50 rounded-lg">
                <div className="w-8 h-8 bg-primary/20 rounded-lg flex items-center justify-center">🌍</div>
                <span className="text-gray-300">Английская версия сайта</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl border border-primary/20 p-8">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link href="/game" className="inline-flex items-center gap-2 px-6 py-3 bg-gray-800 text-white rounded-xl font-semibold hover:bg-gray-700 transition-all">
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-400 text-sm">Email для связи</p>
              ...
              <div className="flex flex-col items-center">
                ...
                <a href="https://github.com/Igoreha1/guitar-learning-app" target="_blank" rel="noopener noreferrer" className="text-white hover:text-primary transition-colors">
                  github.com/Igoreha1
                </a>
              </div>
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-400 text-sm">Присоединяйтесь</p>
                <span className="text-white">ВКонтакте • Telegram</span>
              </div>
            </div>
          </div>
        </div>
